...
class EM_Attendee_Form extends EM_Form {
    ...
    function get_post( $validate = false, $ticket_id = 0, $attendee_index = 0 ){
    	...
    	foreach($this->form_fields as $field){
    		...
    		if( isset($_REQUEST['em_attendee_fields'][$ticket_id][$attendee_index][$fieldid]) && $_REQUEST['em_attendee_fields'][$ticket_id][$attendee_index][$fieldid] != '' ){
    			...
    			}elseif( is_array($_REQUEST['em_attendee_fields'][$ticket_id][$attendee_index][$fieldid])){
    				$array = array();
