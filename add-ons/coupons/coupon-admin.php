...
class EM_Coupon_Admin extends EM_Coupon {
	...
	function get_post($validate = true){
		...
		$this->coupon_code = ( !empty($_POST['coupon_code']) ) ? wp_kses_data($_POST['coupon_code']):'';
		$this->coupon_name = ( !empty($_POST['coupon_name']) ) ? wp_kses_data($_POST['coupon_name']):'';
		$this->coupon_description = ( !empty($_POST['coupon_description']) ) ? wp_kses_data($_POST['coupon_description']):null;
		$this->coupon_start = ( !empty($_POST['coupon_start']) ) ? $_POST['coupon_start']:null;
		$this->coupon_end = ( !empty($_POST['coupon_end']) ) ? $_POST['coupon_end']:null;
		$this->coupon_max = ( !empty($_POST['coupon_max']) && is_numeric($_POST['coupon_max']) ) ? $_POST['coupon_max']:null;
		$this->coupon_type = ( !empty($_POST['coupon_type']) ) ? $_POST['coupon_type']:null;
		$this->coupon_tax = ( !empty($_POST['coupon_tax']) && in_array($_POST['coupon_tax'], array('pre','post')) ) ? $_POST['coupon_tax']:null;
