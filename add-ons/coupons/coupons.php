...
class EM_Coupons extends EM_Object {
	...
	public static function wp_head(){
		...
		?>
		<style type="text/css">
			#em-coupon-loading { display:block; width:16px; height: 16px; margin-left:4px; background:url(<?php echo plugins_url('events-manager-pro/includes/images/spinner.gif','events-manager-pro'); ?>)}
