		...
		<div class="ticket-dates em-time-range em-date-range">
			<div class="ticket-dates-from">
				...
				<div class="ticket-dates-from-normal">
					<input type="date" class="em-date-input-loc em-date-start" name="em_tickets[<?php echo $col_count; ?>][ticket_start]" class="em-date-input ticket_start" value="<?php echo ( !empty($EM_Ticket->ticket_start) ) ? $EM_Ticket->start()->format("Y-m-d"):''; ?>" />
				</div>
			...
			<div class="ticket-dates-to">
				...
				<div class="ticket-dates-to-normal">
					<input type="date" name="em_tickets[<?php echo $col_count; ?>][ticket_end]" name="ticket_end_pub" class="em-date-input-loc em-date-end" value="<?php echo ( !empty($EM_Ticket->ticket_end) ) ? $EM_Ticket->end()->format("Y-m-d"):''; ?>"/>
				</div>
