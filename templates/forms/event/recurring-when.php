...
<div id="em-form-recurrence" class="event-form-recurrence event-form-when">
	<p class="em-time-range">
		...
		<input class="em-time-input em-time-start" type="time" size="8" maxlength="8" name="event_start_time" value="<?php echo $EM_Event->start(); ?>" />
		<?php _e('to','events-manager'); ?>
		<input class="em-time-input em-time-end" type="time" size="8" maxlength="8" name="event_end_time" value="<?php echo $EM_Event->end(); ?>" />
    ...
    <?php _e ( 'This event repeats', 'events-manager'); ?> 
		...
		<p class="alternate-selector" id="weekly-selector">
			<?php
				...
				Contexis\Events\Options::checkbox_items ( 'recurrence_bydays[]', $days_names, $saved_bydays ); 
			?>
		</p>
