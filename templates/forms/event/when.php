...
<div class="event-form-when" id="em-form-when">
	...
	<div class="components-panel__row">
		<label class="components-base-control__label"><?php _e ( 'From ', 'events'); ?></label>
		
		<input class="em-date-input" id="event_start_date" type="date" name="event_start_date" value="<?php echo $start_date ?>" />
	</div>
	<div class="components-panel__row">
		<label class="components-base-control__label"><?php _e ( 'to', 'events'); ?></label>
	...
	<div class="components-panel__row">
	<?php _e('All day','events'); ?> <input type="checkbox" class="em-time-all-day" name="event_all_day" value="1" <?php if(!empty($EM_Event->event_all_day)) echo 'checked="checked"'; ?> />
	</div>
	
	
	<span id='event-date-explanation'>
	<?php esc_html_e( 'This event spans every day between the beginning and end date, with start/end times applying to each day.', 'events'); ?>
	</span>
</div>  
