					...
					<div className="modal__dialog">
						...
						<div className="modal__content">
							<div className="wizzard__steps">
								...
								<div
									className={ `wizzard__step ${ wizzard.step == 1 ? ' wizzard__step--active' : '' } ${
								...
								<div
									className={ `wizzard__step ${ wizzard.step == 2 ? ' wizzard__step--active' : '' } ${
										wizzard.step == 3 ? '' : ''
								...
								<div
									className={ `wizzard__step ${ wizzard.step == 3 ? ' wizzard__step--active' : '' } ${
										wizzard.step == 2 ? ' ' : ''
									}` }
								>
									<div className="container">
