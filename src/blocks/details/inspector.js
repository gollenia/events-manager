...
const Inspector = ( props ) => {
	...
	return (
		<InspectorControls>
			<PanelBody title={ __( 'Audience', 'events' ) } initialOpen={ true }>
				<ToggleControl
			...
			<PanelBody title={ __( 'Location', 'events' ) } initialOpen={ true }>
				<ToggleControl
			...
			<PanelBody title={ __( 'Date and Time', 'events' ) } initialOpen={ true }>
				<ToggleControl
				...
				/>
				<ToggleControl
					label={ __( 'Show booking end', 'events' ) }
					checked={ showBookingEnd }
					onChange={ ( value ) => setAttributes( { showBookingEnd: value } ) }
				/>
			</PanelBody>
			<PanelBody title={ __( 'Speaker', 'events' ) } initialOpen={ true }>
				<ToggleControl
			...
			<PanelBody title={ __( 'Price', 'events' ) } initialOpen={ true }>
				<ToggleControl
			...
			<PanelBody title={ __( 'Booked up warning', 'events' ) } initialOpen={ true }>
				<ToggleControl
